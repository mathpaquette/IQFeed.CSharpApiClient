...
{
    public static class DynamicUpdateSummaryMessageTypesFactory
    {
        ...
        static DynamicUpdateSummaryMessageTypesFactory()
        {
#if NETFRAMEWORK
        ...
        public static Type GenerateDynamicObjectType(DynamicFieldset[] fieldNames)
        {
            ...
            lock (GeneratedTypes)
            {
                ...
                var typeBuilder = dynamicTypesModule.DefineType("UpdateSummaryMessage_AutoGenerated_" + Guid.NewGuid().ToString("N"), TypeAttributes.Public | TypeAttributes.Class);
                typeBuilder.AddInterfaceImplementation(typeof(IUpdateSummaryMessage));
