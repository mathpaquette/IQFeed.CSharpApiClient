...
namespace IQFeed.CSharpApiClient.Streaming.Level1.Messages
{
    public class UpdateSummaryMessageDynamic : IUpdateSummaryMessageDynamic
    {
        ...
        public DateTime ExtendedTradeDate { get { if (_valuesByFieldType.TryGetValue(DynamicFieldset.ExtendedTradeDate, out var value)) { DateTime.TryParseExact(value, UpdateMessageDateFormat, CultureInfo.InvariantCulture, DateTimeStyles.None, out var fieldValue); return fieldValue; } throw new Exception("Dynamic field [Extended Trade Date] not found"); } }
