...
namespace IQFeed.CSharpApiClient.Lookup.Historical
{
    public interface IHistoricalFacade<TTickMessages, TIntervalMessages, TDailyWeeklyMonthlyMessages>
    {
        ...
        Task<TTickMessages> ReqHistoryTickDatapointsAsync(string symbol, int maxDatapoints, DataDirection? dataDirection = null, string requestId = null, int? datapointsPerSend = null);
        ...
        /// <param name="requestId"></param>
        /// <param name="datapointsPerSend"></param>
        Task<TTickMessages> ReqHistoryTickTimeframeAsync(string symbol, DateTime? beginDate, DateTime? endDate, int? maxDatapoints = null, TimeSpan? beginFilterTime =  null, TimeSpan? endFilterTime = null, DataDirection? dataDirection = null, string requestId = null, int? datapointsPerSend = null);
        ...
        Task<TIntervalMessages> ReqHistoryIntervalDatapointsAsync(string symbol, int interval, int maxDatapoints, DataDirection? dataDirection = null, string requestId = null, int? datapointsPerSend = null, HistoricalIntervalType? intervalType = null, LabelAtBeginning? labelAtBeginning = null);
        ...
        /// <param name="requestId"></param>
        /// <param name="datapointsPerSend"></param>
        Task<TDailyWeeklyMonthlyMessages> ReqHistoryDailyDatapointsAsync(string symbol, int maxDatapoints, DataDirection? dataDirection = null, string requestId = null, int? datapointsPerSend = null);
        ...
        /// <param name="requestId"></param>
        /// <param name="datapointsPerSend"></param>
        Task<TDailyWeeklyMonthlyMessages> ReqHistoryDailyTimeframeAsync(string symbol, DateTime? beginDate, DateTime? endDate, int? maxDatapoints = null, DataDirection? dataDirection = null, string requestId = null, int? datapointsPerSend = null);
        ...
        /// <param name="requestId"></param>
        /// <param name="datapointsPerSend"></param>
        Task<TDailyWeeklyMonthlyMessages> ReqHistoryWeeklyDatapointsAsync(string symbol, int maxDatapoints, DataDirection? dataDirection = null, string requestId = null, int? datapointsPerSend = null);
        ...
        /// <param name="requestId"></param>
        /// <param name="datapointsPerSend"></param>
        Task<TDailyWeeklyMonthlyMessages> ReqHistoryMonthlyDatapointsAsync(string symbol, int maxDatapoints, DataDirection? dataDirection = null, string requestId = null, int? datapointsPerSend = null);
    }
}