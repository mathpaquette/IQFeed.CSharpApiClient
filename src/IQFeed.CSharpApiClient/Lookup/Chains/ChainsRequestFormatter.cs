namespace IQFeed.CSharpApiClient.Lookup.Chains
{
    public class ChainsRequestFormatter
    {
            ...
            OptionFilterType optionFilter = OptionFilterType.None, int? filterValue1 = null, int? filterValue2 = null, string requestId = null, bool includeNonStandardOptions = false)
        {
            ...
            var request = $"CEO,{symbol},{optionSideFilter.ToString().ToLower()},{monthCodes},{nearMonths},{(int)binaryOptionFilter},{(int)optionFilter},{filterValue1},{filterValue2},{requestId},{wireFormatIncludeNonStandardOptions}{IQFeedDefault.ProtocolTerminatingCharacters}";
            return request;
        }
    }
}