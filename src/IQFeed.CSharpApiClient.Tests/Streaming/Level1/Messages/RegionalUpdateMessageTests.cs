...
namespace IQFeed.CSharpApiClient.Tests.Streaming.Level1.Messages
{
    public class RegionalUpdateMessageTests
    {
        ...
        public void Should_Parse_RegionalUpdateMessage_Culture_Independant(string cultureName)
        {
            // Arrange
            ...
            var regionalUpdateMessage = new RegionalUpdateMessage("AAPL", "X", 1.23f, 100, new DateTime(2000, 1, 2, 13, 00, 00), 1.24f, 200, new DateTime(2000, 1, 2, 13, 00, 01), 0, 1, 2);
