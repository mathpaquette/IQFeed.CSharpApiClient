...
{
    internal class StreamingLevel2_MBO
    {
        public async Task RunAsync()
        {
            ...
            // For protocol 6.2+, use ReqWatchMarketByOrder
            level2Client.ReqWatchMarketByOrder("@ES#");
        ...
        private void Level2Client_MBOSummary(OrderAddUpdateSummaryMessage msg)    // Added for protocol 6.2
        {
